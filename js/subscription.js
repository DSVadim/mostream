...
// Event listener for the "Show Detail Package" button
document.querySelector('.section1-container1-buttons__btn2').addEventListener('click', function () {
    ...
    const html = `
        <div id="modal" class="modal" style="display: flex; align-items: center; justify-content: center; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5);">
            <div class="modal-content" style="background-color: rgba(17,17,17,0.5); padding: 30px; border-radius: 5px; max-width: 500px; width: 90%; position: relative;">
                <span class="close-btn" onclick="closeModal()" style="position: absolute; top: 10px; right: 10px; cursor: pointer; font-size: 20px;">&times;</span>
                ...
                <p class="modal-content__subtitle">Basic Subscription - 30 Day - All Device</p>
                <p class="modal-content__subtitle"><strong>Price:</strong> $8.99/month</p>
